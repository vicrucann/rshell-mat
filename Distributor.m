classdef Distributor < handle
    ...
    methods
        ...
        function obj = Distributor(login, path_rem, ipaddrs, path_vars, vars, path_curr, sleeptime, path_res, printout)
            ...
            if (obj.ncluster > 1)
                mkdir(obj.path_res);
                delete([obj.path_res '*.log']);
                delete([obj.path_res 'result*.mat']);
                obj.test_connection();
            end
        ...
        function test_connection(obj)
            ...
            if ~obj.printout
               ...
               cmdStr = [cmdStr ' >>' obj.path_res 'tester.log'];
            end
        ...
        function out_merge = launch(obj, h_split, in_split, h_kernel, h_merge, in_merge)   
            ...
            if ~obj.printout
                ...
                cmdStr = [cmdStr ' >>' obj.path_res remmat '.log'];
            end
        ...
        function status = scp_cached_data(obj, cnda) % where cnda is CachedNDArray data structure
            ...
            if ~obj.printout
                ...
                cmdStr = [cmdStr ' >>' obj.path_res 'transfer.log'];
            end
            if (obj.printout)
                t_dtransfer = tic;
